...
//   String name = "", school = "", email = "", teacherClass = "", password = "";
...
//     return Scaffold(
//       appBar: AppBar(title: const Text("Registrasi Guru")),
//       body: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        TextFormField(
                          ...
                          validator: (v) => v!.length < 6 ? "Minimal 6 karakter" : null,
                          onSaved: (v) => password = v!,
                          onFieldSubmitted: (_) => _register(), // Diperbaiki di sini
                        ),
                        const SizedBox(height: 16),
